...
def vue_reporting(page: ft.Page):
    ...
    def ouvrir_export_reservations(e):
        import webbrowser
        webbrowser.open("http://127.0.0.1:8000/api/v1/reporting/export/reservations")

    def ouvrir_export_paiements(e):
        import webbrowser
        webbrowser.open("http://127.0.0.1:8000/api/v1/reporting/export/paiements")

    def ouvrir_export_reservations_excel(e):
        import webbrowser
        webbrowser.open("http://127.0.0.1:8000/api/v1/reporting/export/reservations-excel")

    def ouvrir_export_paiements_excel(e):
        import webbrowser
        webbrowser.open("http://127.0.0.1:8000/api/v1/reporting/export/paiements-excel")
