...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="Cimetière Municipal <noreply@cimetiere-pn.cg>")
...
APP_NAME = env("APP_NAME", default="Cimetière Municipal de Pointe-Noire")
